...
public class WithdrawFrame extends JFrame {
    ...
    WithdrawFrame(String no, Connection c) {
        setTitle("Withdraw");
    ...
    public void setLocationAndSize() {
        ...
        withdrawBtn.setBounds(140, 410, 100, 30);
    ...
    boolean withdrawSQL(int amount) {
        ...
        withdrawBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (amt > 10000) {
                    ...
                    int result = JOptionPane.showConfirmDialog(new JFrame(), "Withdrawal of INR " + amountTf.getText(), "Confirm Withdrawal",
                            JOptionPane.YES_NO_OPTION,
                            JOptionPane.QUESTION_MESSAGE);
                    if (result == JOptionPane.YES_OPTION) {
                        label.setText("You selected: Yes");
                        if (withdrawSQL(amt) == true) {
                            JOptionPane.showMessageDialog(new JFrame(), "Cash Withdrawn \n Thank You for Banking with Us!");
                            dispose();
